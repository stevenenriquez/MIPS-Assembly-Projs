...
##########################################
#############  Register Map  #############
#####  $s0: addr. past end of array  #####
# $t0: addr. of current element of array #
#  $t2: counter for while loop in sort   #
##########################################
...
print_loop:
	...
	li $v0, 11
	li $a0, '\n'		 # print new line, puts each number on its own line
	syscall
...
sort_loop:
	beq $t0, $s2, quit_sort  # termination
